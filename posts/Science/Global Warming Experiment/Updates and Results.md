...
4. Drain.
5. Place each half of the sclerotium on the left half of the petri dish with agar base (one half in the petri dish Ctrl #1, the other half in the petri dish Exp #1).
